...
namespace SalaryInfrastructure.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public PositionsController(DbSalaryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,BaseSalary")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Basesalary,Createdat,Updatedat")] Position position)
        {
            if (id != position.Id)
            {
                return NotFound();
